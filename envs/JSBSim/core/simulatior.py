...
class AircraftSimulator(BaseSimulator):
    ...
    def __init__(self,
        ...
        #init_state {'ic_lat_geod_deg': 60.05, 'ic_long_gc_deg': 120.0, 'ic_h_sl_ft': 20000, 'ic_psi_true_deg': 180.0, 'ic_u_fps': 800.0}
        #init_state {'ic_long_gc_deg': 120.0, 'ic_lat_geod_deg': 60.0, 'ic_h_sl_ft': 20000, 'ic_psi_true_deg': 0.0, 'ic_u_fps': 800.0}
    ...
    def get_init_state(self):
        init_state1 = {'ic_lat_geod_deg': 60.05, 'ic_long_gc_deg': 120.0, 'ic_h_sl_ft': 20000, 'ic_psi_true_deg': 180.0, 'ic_u_fps': 800.0}
        init_state2 = {'ic_lat_geod_deg': 60.0, 'ic_long_gc_deg': 120.0,  'ic_h_sl_ft': 20000, 'ic_psi_true_deg': 0.0, 'ic_u_fps': 800.0}

        init_state = {}
        for key in init_state1.keys():
            if isinstance(init_state1[key], (int, float)):
                init_state[key] = random.uniform(min(init_state1[key], init_state2[key]), max(init_state1[key], init_state2[key]))
            else:
                init_state[key] = init_state1[key]  # Assuming non-numeric values remain unchanged
        return init_state
